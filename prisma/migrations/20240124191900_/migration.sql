...
CREATE TABLE "Order" (
    ...
    "status" TEXT NOT NULL DEFAULT 'Waiting confirmatin from kitchen',
    "userEmail" TEXT NOT NULL,
    "tableSlug" TEXT NOT NULL DEFAULT 'table1',
...
-- CreateIndex
CREATE UNIQUE INDEX "Table_title_key" ON "Table"("title");
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_tableSlug_fkey" FOREIGN KEY ("tableSlug") REFERENCES "Table"("title") ON DELETE RESTRICT ON UPDATE CASCADE;
